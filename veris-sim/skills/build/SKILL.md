...
`scripts/veris.sh` in this skill's directory does the mechanics (`sh`).
...
stored (`veris.sh data`, `veris.sh requests`). **Not done until the receipt
...
Paste the sandbox id. Then `veris.sh sandbox delete <id>`.
